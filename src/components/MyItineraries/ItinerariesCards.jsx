...
export default function ItinerariesCards(props) {
  ...
  return (
    <>
      <div className="container-main-cards-and-edit">
        <div className="card-shows-iti">
          ...
          <div className="buttons-shows-by">
            ...
            <button
              className="button-byShows-delete"
              value={id}
        ...
        <div className="container-edit-shows">
